...
screen main_menu():
    ...
    frame:
        ...
        ##add  SnowBlossom("gui/sakura.png", count=10, border=50, xspeed=(20, 50), yspeed=(100, 200), start=0, fast=False, horizontal=False)    
    ## The use statement includes another screen inside this one. The actual
    ## contents of the main menu are in the navigation screen.
    $ renpy.music.play("audio/trilhas/your_past.ogg", loop=True)
...
screen keyboard_help():
    ...
    hbox:
        label _("Esc")
        text _("Acessa o menu do game.")

    hbox:
        label _("Ctrl")
        text _("Ignora o diálogo enquanto é pressionado.")
    ...
    hbox:
        label _("Page Down")
        text _("Avança para o diálogo posterior.")

    hbox:
        label "H"
        text _("Oculta caixa de texto.")
    ...
    hbox:
        label "V"
        text _("Alterna a {a=https://www.renpy.org/l/voicing}auto-voz{/a} assistida.")
